...
@Getter
@NoArgsConstructor
public abstract class AbstractAnthropicChat extends AbstractAnthropic {
    ...
    @Schema(
        title = "Temperature",
        description = "Sampling randomness; range 0.0-1.0. Unset by default and only sent to Anthropic when explicitly provided. Lower for deterministic replies."
    )
    protected Property<@Max(1) Double> temperature;
